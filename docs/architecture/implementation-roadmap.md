...
**Shipped since the last status:** the **mechanical em-dash guard** (post-write normalizer on the doc/content output path) and **P5 MONEY + people-ops** (see the P5 section for the detailed plan and what reshaped vs the original spec).
