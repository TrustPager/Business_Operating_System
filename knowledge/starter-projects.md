...
| **The words for your post, in your voice** | Give me the idea and I'll write the on-brand caption and body in your voice — positive and outcome-led, ready to publish. | `write-post-copy` `[live]`, `plan-my-content` `[live]` | keyless | first_build |
...
| **A website that's unmistakably yours, running today** | Show me two or three sites you admire and tell me your taste, and I'll build you a bespoke, high-converting landing page or site off your brand and the sites you love, with copy that converts and ranks, running on your own machine in a sitting. Not a template. Taking it live on a real URL is the connect-time next step. | `design-my-site` `[live]` | keyless | first_build |
| **Take that site live on a real URL** | Once you've built your site with `design-my-site` on your own machine, I'll put it live on the internet on a real, shareable URL. Connect a Vercel account once (a free, one-time sign-in), and from then on every future update ships live with a word. Build it keyless, then take it live. | `launch-my-site` `[live]`, `design-my-site` `[live]` | needs_connection | deeper |
