...
1. **They named two or more things eating their week → ASK, don't pick.** One line: *"I can go straight at [X] or [Y] — which do you want to punch first?"* (Still inside the ≤3-question budget; the owner aiming the win IS part of the win.) Then route their answer by the signal list below.
