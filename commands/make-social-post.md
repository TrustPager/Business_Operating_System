---
description: Design and render a branded social post (Instagram square/portrait, LinkedIn, or X) using the bundled Social Studio. Browser preview → puppeteer-rendered PNG → optional one-command publish to your TrustPager Files folder.
---
