...
Invoke the skill at `skills/form-radar/SKILL.md`. It gathers form sends and
submissions via `trustpager` MCP read tools (the skill lets you tune the
stale-unopened window in plain language, e.g. "use a 5-day stale window"), then
presents the report bucketed by follow-up urgency: STARTED-NOT-FINISHED first (a nudge closes
