---
description: Turn a rough ask into a complete, explicit prompt you can hand to a person or to Claude. Fills the gaps (goal, context, exact inputs, steps, output format, constraints, how to verify) and returns a ready-to-paste prompt — no vague placeholders.
---
