...
// Headless OG Image Renderer
// Launches Puppeteer against the Vite dev server, navigates to each design,
// screenshots the .template-canvas element at native 1200×630, saves to output/.
//
// Usage:
//   npm run dev                   # start the dev server first (port 3217)
//   npm run render -- docs-home
...
// One entry per template id — keep in lockstep with the templateMeta size
// declared in src/templates/OgImage.jsx.
const TEMPLATE_SIZES = {
  'og-image': { width: 1200, height: 630 }, // Open Graph / social-share standard
};
...
async function renderDesign(browser, key, sample) {
  ...
  // output (1200×630) regardless of the editor's preview zoom.
