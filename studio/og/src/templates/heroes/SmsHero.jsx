...
const Bubble = ({ b, last }) => {
  ...
  return (
    <div style={{
      ...
      <div style={{
        background: fromThem ? '#f1f5f9' : 'var(--brand-primary)',
        ...
        maxWidth: '85%',
        boxShadow: fromAi
          ? '0 2px 8px color-mix(in srgb, var(--brand-primary) 25%, transparent), 0 0 0 1px color-mix(in srgb, var(--brand-primary) 18%, transparent)'
