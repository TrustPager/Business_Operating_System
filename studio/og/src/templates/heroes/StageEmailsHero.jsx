...
const STATUS = {
  delivered: { fg: 'var(--brand-primary-deep)', bg: 'color-mix(in srgb, var(--brand-primary) 16%, transparent)', label: '✓ DELIVERED' },
  opened:    { fg: 'var(--brand-secondary)', bg: 'color-mix(in srgb, var(--brand-secondary) 16%, transparent)', label: '✓ OPENED' },
  replied:   { fg: 'var(--brand-secondary)', bg: 'color-mix(in srgb, var(--brand-secondary) 22%, transparent)', label: '✓ REPLIED' },
};
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
        ...
        <span style={{
          fontSize: 9, fontWeight: 800, letterSpacing: '0.08em',
          color: e.toColor,
          background: `${`color-mix(in srgb, ${e.toColor} 12%, transparent)`}`,
          padding: '3px 7px', borderRadius: 4,
      ...
      <div style={{
        ...
        <div style={{
          ...
          color: 'var(--brand-primary-deep)', fontSize: 12, fontWeight: 800,
          flexShrink: 0,
        }}>✉</div>
