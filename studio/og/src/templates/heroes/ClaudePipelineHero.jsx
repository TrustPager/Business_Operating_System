...
const STATE = {
  built:    { fg: 'var(--brand-secondary)', bg: 'color-mix(in srgb, var(--brand-secondary) 18%, transparent)', label: '✓ BUILT' },
  building: { fg: 'var(--brand-primary-deep)', bg: 'color-mix(in srgb, var(--brand-primary) 22%, transparent)', label: '● BUILDING' },
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 9, minWidth: 0, flex: 1 }}>
          <div style={{
            ...
            background: isBuilt
              ? `linear-gradient(135deg, ${s.color}, ${`color-mix(in srgb, ${s.color} 80%, transparent)`})`
              : 'rgba(148,163,184,0.16)',
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            boxShadow: isBuilt ? `0 4px 10px ${`color-mix(in srgb, ${s.color} 25%, transparent)`}` : 'none',
            flexShrink: 0,
          }}>
