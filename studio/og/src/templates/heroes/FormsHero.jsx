...
// from a form submission. Each row is one field with the value auto-filled,
// a sparkle pill showing "auto-filled" provenance, and a progress bar.
//
// Brand-aware: chrome colours come from CSS variables (--brand-primary,
// --brand-primary-deep, --brand-gradient) injected by OgImage.jsx.
...
const FieldRow = ({ f }) => {
  ...
  return (
    <div style={{
      ...
      boxShadow: filling ? `0 4px 14px ${`color-mix(in srgb, var(--brand-primary) 18%, transparent)`}` : 'none',
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: 'var(--brand-gradient)',
          borderRadius: 999,
          boxShadow: `0 1px 4px ${`color-mix(in srgb, var(--brand-primary) 40%, transparent)`}`,
        }} />
      </div>
