...
const EVENTS = [
  { day: 'Today',     time: '9:00',  duration: '30m', title: 'Discovery — Coastal Health',     attendees: ['Sarah Hartley','Simon [name]'],                       source: 'gcal',    sourceColor: 'var(--brand-primary)' },
  { day: 'Today',     time: '11:00', duration: '45m', title: 'Workflow Audit — Otis Chen',     attendees: ['Otis Chen','Simon [name]'],                           source: 'tp',      sourceColor: 'var(--brand-secondary)' },
  { day: 'Today',     time: '14:00', duration: '60m', title: 'Internal — Sprint Review',       attendees: ['Simon [name]','Jordan Park','Mira Suarez'],           source: 'outlook', sourceColor: 'var(--brand-accent)' },
  { day: 'Tomorrow',  time: '8:30',  duration: '30m', title: 'Renewal call — Hugo Daniels',    attendees: ['Hugo Daniels','Simon [name]'],                        source: 'gcal',    sourceColor: 'var(--brand-primary)' },
  { day: 'Tomorrow',  time: '10:00', duration: '15m', title: 'Quick chat — Asher Patterson',   attendees: ['Asher Patterson','Simon [name]'],                     source: 'tp',      sourceColor: 'var(--brand-secondary)' },
  { day: 'Tomorrow',  time: '13:00', duration: '60m', title: 'Strategy — Camille Anders',      attendees: ['Camille Anders','Simon [name]'],                      source: 'gcal',    sourceColor: 'var(--brand-primary)' },
  { day: 'Fri 11',    time: '9:00',  duration: '45m', title: 'Anya Faulkner — Audit',          attendees: ['Anya Faulkner','Simon [name]','Jordan Park'],         source: 'tp',      sourceColor: 'var(--brand-secondary)' },
  { day: 'Fri 11',    time: '11:30', duration: '30m', title: 'Doctor appt',                    attendees: ['Simon [name]'],                                       source: 'gcal',    sourceColor: 'var(--brand-primary)', personal: true },
];
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginTop: 4 }}>
          <span style={{
            ...
            color: e.sourceColor,
            background: `${`color-mix(in srgb, ${e.sourceColor} 12%, transparent)`}`,
