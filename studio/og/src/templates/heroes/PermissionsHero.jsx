  ...
  if (on) {
    return (
      <div style={{
        ...
        boxShadow: '0 2px 5px color-mix(in srgb, var(--brand-primary) 35%, transparent)',
      }}>✓</div>
    );
  }
  return (
...
const SectionLabel = ({ label, color, count }) => (
  <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '4px 2px 6px 2px' }}>
    ...
    <span style={{ flex: 1, height: 1, background: `${`color-mix(in srgb, ${color} 13%, transparent)`}` }} />
    <span style={{
...
const ShieldIcon = () => (
  <div style={{
    ...
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
      ...
      <path d="M9.5 12.5l2 2 4-4" stroke="var(--brand-primary-deep)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  </div>
);
  ...
  <div style={{
    ...
    <div style={{
      ...
      <span style={{
        ...
        boxShadow: '0 2px 6px color-mix(in srgb, var(--brand-secondary) 30%, transparent)',
        flexShrink: 0,
      }}>18 SCOPES ON</span>
    </div>
