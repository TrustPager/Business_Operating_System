...
const Heading = ({ children, color = 'var(--brand-primary-deep)' }) => (
  <div style={{
  ...
  <div style={{
    ...
    <PaperPage label="PAGE 1">
      <div style={{
        ...
        <div style={{ fontSize: 11, fontWeight: 800, letterSpacing: '0.12em', color: 'var(--brand-primary-deep)', marginBottom: 4 }}>
          PROPOSAL · Q3 2026
        </div>
    ...
    <PaperPage label="PAGE 2">
      <Heading color="var(--brand-secondary)">Investment Summary</Heading>
    ...
    <PaperPage label="PAGE 3">
      <Heading color="var(--brand-accent)">Terms & Conditions</Heading>
      <DocLine w="100%" />
      <DocLine w="92%" />
      <DocLine w="88%" />
      <DocLine w="95%" />
