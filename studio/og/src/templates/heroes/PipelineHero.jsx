...
const DEALS = [
  { account: 'Coastal Health Group',   value: '$96k',  tag: 'Inbound',   avatar: 'CH', avatarColor: 'var(--brand-primary)', dragging: false },
  { account: 'Wattle Creek Winery',    value: '$54k',  tag: 'Email',     avatar: 'WC', avatarColor: 'var(--brand-accent)', dragging: true  },
  { account: 'Pinnacle Engineering',   value: '$78k',  tag: 'Referral',  avatar: 'PE', avatarColor: 'var(--brand-secondary)', dragging: false },
  { account: 'Eucalyptus Wealth',      value: '$33k',  tag: 'Website',   avatar: 'EW', avatarColor: 'var(--brand-light)', dragging: false },
  { account: 'Southern Cross Legal',   value: '$120k', tag: 'Direct',    avatar: 'SC', avatarColor: 'var(--brand-primary)', dragging: false },
  { account: 'Ironbark Construction',  value: '$67k',  tag: 'Inbound',   avatar: 'IC', avatarColor: 'var(--brand-secondary)', dragging: false },
  { account: 'Outback Solar Solutions',value: '$28k',  tag: 'LinkedIn',  avatar: 'OS', avatarColor: 'var(--brand-accent)', dragging: false },
  { account: 'Reef & Co Logistics',    value: '$42k',  tag: 'Referral',  avatar: 'RC', avatarColor: 'var(--brand-primary)', dragging: false },
  { account: 'Banksia Financial',      value: '$15k',  tag: 'Website',   avatar: 'BF', avatarColor: 'var(--brand-light)', dragging: false },
];

const CARD_SHADOW = '0 1px 2px rgba(15,17,23,0.05), 0 0 0 1px rgba(15,17,23,0.07)';
const DRAG_SHADOW = '0 16px 36px color-mix(in srgb, var(--brand-primary) 30%, transparent), 0 0 0 1.5px color-mix(in srgb, var(--brand-primary) 45%, transparent)';
...
export const PipelineHero = () => (
  <div style={{
    ...
    <div style={{
      background: `linear-gradient(135deg, ${STAGE.color}, var(--brand-accent))`,
      borderRadius: 12,
      padding: '14px 18px',
      display: 'flex', alignItems: 'center', justifyContent: 'space-between',
      boxShadow: `0 4px 14px ${`color-mix(in srgb, ${STAGE.color} 25%, transparent)`}`,
    }}>
