// BOS OG Image Studio
// Browser-based editor for previewing Open Graph (social-share) images.
// Run: npm run dev → opens at http://localhost:3217
//
// Sidebar: design gallery grouped by template (one folder — OG Image,
// 1200×630) + JSON-driven samples. One sample per page/route you want a
// custom link preview for.
// Main area: live preview. Defaults to "Fit" — the canvas auto-scales to
// your window. Pick a fixed % to inspect at a set scale.
            ...
            {resolved && (
              <>
                <CommandChip
                  ...
                  tooltip="Click to copy. Render the PNG locally to output/."
                ...
                <CommandChip
                  ...
                  tooltip="Click to copy. Render + upload to your TrustPager workspace's Files > OG Images folder."
