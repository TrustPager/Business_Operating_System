// Brand kit loader for the BOS Social studio.
//
// Identical pattern to studio/thumbnails/src/brand.js — every studio
// reads from the SAME brand.json at the BOS root, so editing it once
// rebrands every studio.
